(function($) {
	...
	SchemaParser.prototype = {
		...
		drawFormsOn : function(hook) {
			var forms_created = {};
			var form_order = [];
			this.createForm(this.root, this.schema, null, forms_created, form_order, "#");
			this.display(hook, forms_created, form_order, false);
		},
	...
	$.fn.schemaFarm = function(schema, form_title){
		this.each(function(){
            var $this = $(this);
            var schema_parser = new SchemaParser(schema, form_title);
            schema_parser.drawFormsOn($this);
        });
        return this;
	}
	...
	$.schemaFarm.UTILS = {
		...
		"Form" : Form,
		"Field" : Field,
		"DynoformStructure" : DynoformStructure
	};
